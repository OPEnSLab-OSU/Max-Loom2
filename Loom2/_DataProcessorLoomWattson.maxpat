...
,
					"patching_rect" : [ 216.0, 245.0, 220.0, 36.0 ],
					"varname" : "patch_5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 240.0, 130.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 44.0, 343.0, 150.0, 250.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 343.0, 150.0, 126.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Patch_Generator.maxpat",
				"bootpath" : "~/Documents/GitHub/Max-Loom2/Loom2",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
