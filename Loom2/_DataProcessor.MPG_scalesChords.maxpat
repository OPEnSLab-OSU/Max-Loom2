...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 165.5, 65.0, 52.0, 27.0 ],
									"text" : "60 62 64 67"
								}
...
,
					"patching_rect" : [ 1356.0, 464.0, 240.0, 160.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.333333333333258, 164.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.333333333333258, 194.0, 113.0, 22.0 ],
					"text" : "prepend chord_root"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1699.0, 695.0, 208.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1356.0, 818.0, 116.0, 23.0 ],
					"text" : "makenote 120 120"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 1356.0, 862.0, 175.0, 23.0 ],
					"text" : "noteout 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1356.0, 696.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1356.0, 768.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1673.0, 768.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 577.0, 610.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 577.0, 573.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 586.5, 656.0, 52.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 585.0, 706.0, 208.0, 54.0 ],
					"text" : "Click the mouse at different heights on each key and watch velocity output."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 242.0, 829.0, 116.0, 23.0 ],
					"text" : "makenote 120 120"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 873.0, 175.0, 23.0 ],
					"text" : "noteout 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.0, 707.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.0, 779.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 559.0, 779.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1389.5, 120.0, 157.0, 20.0 ],
					"text" : "<< open or close data path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1233.5, 73.0, 86.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1325.5, 73.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1355.5, 120.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1393.5, 223.0, 295.0, 20.0 ],
					"text" : "<< mod numbers to repeat by length of the sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1418.5, 195.0, 172.0, 20.0 ],
					"text" : "<< get length of the sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1638.0, 156.0, 206.0, 20.0 ],
					"text" : "<< scale degree sequence message"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1355.5, 156.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1356.0, 223.0, 29.5, 22.0 ],
					"text" : "% 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1378.5, 193.0, 37.0, 22.0 ],
					"text" : "zl len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1561.0, 156.0, 75.0, 22.0 ],
					"text" : "0 1 2 3 2 1 4"
				}
...
,
					"patching_rect" : [ 1356.0, 256.0, 224.0, 152.0 ],
					"varname" : "patch_0[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1411.5, 73.0, 310.0, 20.0 ],
					"text" : "<< you can add delay times (in ms) to solve sync issues"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1368.5, 73.0, 41.0, 22.0 ],
					"text" : "pipe 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1368.5, 43.0, 86.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1412.5, 417.0, 275.0, 33.0 ],
					"text" : "Translates chord degrees into pitches depending on tonic, scale, root, and chord structure"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 903.5, 706.0, 355.0, 33.0 ],
					"text" : "<< translates MIDI pitch to retuning the pitch of an audio sample.\nparam: original midi pitch of sample to transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 437.0, 502.0, 20.0 ],
					"text" : "Translate scale degree numbers into MIDI pitches depending on tonic and scale parameters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 653.0, 141.0, 157.0, 20.0 ],
					"text" : "<< open or close data path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 94.0, 86.0, 20.0 ],
					"text" : "click to enable"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 94.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.0, 141.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 244.0, 295.0, 20.0 ],
					"text" : "<< mod numbers to repeat by length of the sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 216.0, 172.0, 20.0 ],
					"text" : "<< get length of the sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 913.0, 177.0, 206.0, 20.0 ],
					"text" : "<< scale degree sequence message"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 619.0, 177.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 829.5, 1009.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 869.0, 741.0, 468.0, 20.0 ],
					"text" : "<< if sample is tuned to C, speed will transpose sample to target MIDI pitch"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 806.5, 774.0, 29.5, 22.0 ],
					"text" : "t 1 f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 806.5, 741.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 806.5, 706.0, 95.0, 22.0 ],
					"text" : "MIDItoSpeed 60"
				}
...
, 							{
								"box" : 								{
									...
									"data" : 									{
										"clips" : [ 											{
												"absolutepath" : "00.c_pizz_fo_c2.aif",
												"filename" : "00.c_pizz_fo_c2.aif",
												"filekind" : "audiofile",
												"loop" : 0,
												"content_state" : 												{
													"originaltempo" : [ 120.0 ],
...
,
					"patching_rect" : [ 806.5, 817.0, 224.0, 149.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 619.5, 464.0, 238.0, 149.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 619.5, 244.0, 29.5, 22.0 ],
					"text" : "% 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 642.0, 214.0, 37.0, 22.0 ],
					"text" : "zl len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 824.5, 177.0, 85.0, 22.0 ],
...
,
					"patching_rect" : [ 619.5, 277.0, 224.0, 152.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 94.0, 310.0, 20.0 ],
					"text" : "<< you can add delay times (in ms) to solve sync issues"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 94.0, 41.0, 22.0 ],
					"text" : "pipe 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 632.0, 64.0, 86.0, 22.0 ],
					"text" : "link.beats 1 32"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 473.0, 150.0, 20.0 ],
					"text" : "<< Beat nums (start w/ 0)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.166666666666742, 473.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.166666666666742, 383.0, 363.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 81.166666666666742, 323.0, 220.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 20.166666666666742, 383.0, 86.0, 22.0 ],
					"text" : "link.beats 1 32"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 20.166666666666742, 323.0, 57.0, 22.0 ],
					"text" : "link.clock"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.666666666666742, 15.0, 183.0, 33.0 ],
					"text" : "Sequencer Sampler Tutorial\nChet Udell summer 2020"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 194.0, 79.0, 22.0 ],
					"text" : "prepend bpm"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 164.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 271.0, 98.0, 22.0 ],
...
,
					"patching_rect" : [ 21.0, 164.5, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 231.0, 253.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "signal" ],
					"patching_rect" : [ 21.0, 231.0, 64.0, 22.0 ],
					"text" : "musiclinks",
					"varname" : "musiclinks"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 1 ],
					"midpoints" : [ 348.5, 858.0, 329.5, 858.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 568.5, 815.0, 300.0, 815.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1462.5, 847.0, 1443.5, 847.0 ],
					"source" : [ "obj-33", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1682.5, 804.0, 1414.0, 804.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-99::obj-16" : [ "live.gain~[1]", "live.gain~", 0 ],
			"parameterbanks" : 			{
