...
,
					"patching_rect" : [ 663.0, 237.0, 220.0, 36.0 ],
					"varname" : "patch_5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1042.0, 588.0, 150.0, 20.0 ],
					"text" : "Output to another device"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1163.0, 466.0, 150.0, 20.0 ],
					"text" : "Trigger relay on or off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 747.0, 489.0, 188.0, 20.0 ],
					"text" : "Route a sensor value to threshold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 267.0, 125.0, 33.0 ],
					"text" : "Set instance number\nof sensing device ->"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "GeneralViewer.maxpat",
					"numinlets" : 2,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 491.0, 335.0, 150.0, 250.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 335.0, 150.0, 126.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "Aux_Threshold.maxpat",
					"numinlets" : 3,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1007.0, 267.0, 105.0, 145.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1007.0, 437.0, 150.0, 85.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "dictionary" ],
					"patching_rect" : [ 1007.0, 547.0, 220.0, 36.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 672.5, 481.0, 969.0, 481.0, 969.0, 248.0, 1016.5, 248.0 ],
					"source" : [ "obj-11", 0 ]
				}
