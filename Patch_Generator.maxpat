...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-4",
					"items" : [ "ModuleCore", ",", "GeneralViewer", ",", "Sensor", ",", "PositionVisualizer", ",", "Neopixel", ",", "Relay", ",", "Servo", ",", "Stepper", ",", "Aux_RangeSetter", ",", "Aux_ScaleCurve", ",", "Aux_ScaleLinear", ",", "Aux_Smooth", ",", "Aux_Threshold" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
